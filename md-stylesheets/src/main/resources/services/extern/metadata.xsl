<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="gmd:MD_Metadata">
		...
		<div id="wie">
			<div class="blok">
				<xsl:apply-templates select="gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:pointOfContact[1]"/>
			</div>
			<div class="blok">
 	...
 	<xsl:template match="gmd:MD_Metadata/gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:abstract/gco:CharacterString">
  	...
  	<xsl:template match="gmd:MD_Metadata/gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:pointOfContact[1]">
	 		...
	 		<div class="blok">
		 		...
		 		<xsl:if test="gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL != ''">
		 			<p>
		 				...
		 				<xsl:choose>
							<xsl:when test="substring(substring-after(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'http'),1,3) = '://'">
								<xsl:value-of select="substring-before(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'http://')"/>
								<xsl:text> </xsl:text>
								<a href="http://{substring-after(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'http://')}">
									http://<xsl:value-of select="substring-after(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'http://')"/>
								</a>
							</xsl:when>
							<xsl:when test="substring(substring-after(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'https'),1,3) = '://'">
								<xsl:value-of select="substring-before(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'https://')"/>
								<xsl:text> </xsl:text>
								<a href="https://{substring-after(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'https://')}">
									https://<xsl:value-of select="substring-after(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'https://')"/>
								</a>
							</xsl:when>
							<xsl:otherwise>
			  	...
			  	<xsl:if test="gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:address/gmd:CI_Address/gmd:administrativeArea/gco:CharacterString != ''">
					<p>
			  	...
			  	<xsl:if test="gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:address/gmd:CI_Address/gmd:country/gco:CharacterString != ''">
					<p>
				...
				<xsl:if test="gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:phone/gmd:CI_Telephone/gmd:facsimile/gco:CharacterString != ''">
					<p>
