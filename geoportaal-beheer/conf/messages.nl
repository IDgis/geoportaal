...
validate.form.fileid.warning.body.2=Het is meestal de bedoeling dat een nummer alleen uit cijfers bestaat. Gewone nummers zijn bijvoorbeeld: 160023 (in 2016), 150101 (in 2015) enz. Combinaties van maximaal 8 cijfers komen ook voor. Dat zijn meestal oudere nummers, zoals 00226467 (uit 2002).
validate.form.fileid.warning.body.3=Is het toch nodig een afwijkend nummer te gebruiken, voorkom dan vreemde tekens (- of _ zijn wel toegestaan). %, @, # en dergelijke, dat wordt afgeraden. Probeer ook de code niet te lang te maken (streef naar minder dan 12 posities).
