...
index.records.count.total.label=Aantal records:
index.records.count.displayed.label=Aantal weergegeven records:
index.records.count.selected.label=Aantal geselecteerde records:
...
form.typeresearch.label=Type onderzoek
form.typeresearch.title=Selecteer het type onderzoek
...
validate.form.fileid.warning.title=Waarschuwing: het nummer is mogelijk niet goed ingevuld
validate.form.fileid.warning.body.number.label=Nummer is:
validate.form.fileid.warning.body.1=Controleer of je het juiste nummer hebt ingevoerd, voordat je verder gaat. 
validate.form.fileid.warning.body.2=Kan het zijn, dat het nummer wat je hebt ingevoerd, al bestaat? Nummers moeten altijd uniek zijn.
validate.form.fileid.warning.body.3=Of is er een fout in het nummer zelf? Het is de bedoeling dat een nummer alleen uit cijfers bestaat. Gewone nummers zijn bijvoorbeeld: 160023 (in 2016), 150101 (in 2015) enzovoorts. Combinaties van maximaal 8 cijfers komen ook voor. Dat zijn meestal oudere nummers, zoals 00226467 (uit 2002).
validate.form.fileid.warning.body.4=Is het toch nodig een afwijkend nummer te gebruiken, gebruik dan geen vreemde tekens. Spaties, %, @, # en dergelijke tekens zijn niet toegestaan. Streepjes (- of _) zijn wel toegestaan). Maak de code niet te lang (streef naar minder dan 12 posities).
