...
SELECT 
	...
	to_tsvector('dutch', coalesce((string_agg(d.thumbnail, ' ')), '')) ||
	to_tsvector('dutch', coalesce((string_agg(d.spatial_schema, ' ')), '')) ||
	to_tsvector('dutch', coalesce((string_agg(d.viewer_url, ' ')), '')) ||
