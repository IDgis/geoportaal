...
about.paragraph.9=GML is voor veel webontwikkelaars niet de eerste keus. JSON en GeoJSON zijn laagdrempeliger waardoor veel webontwikkelaars daar de voorkeur aan geven. Gelukkig is het GeoJSON formaat ook beschikbaar bij de WFSen die GeoPublisher aanbiedt. Gebruik daarvoor de parameter outputformat=json bij een GetFeature request en je krijgt GeoJSON terug. Voorbeeld:
about.paragraph.10=<a class="link" target="_blank" href="http://services.geodataoverijssel.nl/geoserver/B51_recreatie/wfs?service=WFS&version=2.0.0&request=GetFeature&typename=B51_recreatie:B5_Fietsroutes_in_Overijssel&count=100&startindex=1&outputformat=json">Fietsroutes in GeoJSON</a>
about.paragraph.11=Een GeoPublisher WFS steunt nog meer formaten, zoals gmp, shp, dxf, kml en csv. Zie voor een volledige opsomming het element 'ows:AllowedValues' onder 'ows:Parameter name="outputFormat"' in de <a class="link" target="_blank" href="http://services.geodataoverijssel.nl/geoserver/B51_recreatie/wfs?request=GetCapabilities">Capabilities van de WFS voor bijv. Recreatie</a>
about.paragraph.12=Van een aantal datasets zijn wij geen eigenaar. Meestal zijn hierbij dan beperkingen voordat ze gedeeld mogen worden met anderen. Deze beperkingen staan ook in de beschrijving bij de datasets.
...
help.paragraph.6.1=GML is voor veel webontwikkelaars niet de eerste keus. JSON en GeoJSON zijn laagdrempeliger waardoor veel webontwikkelaars daar de voorkeur aan geven. Gelukkig is het GeoJSON formaat ook beschikbaar bij de WFSen die GeoPublisher aanbiedt. Gebruik daarvoor de parameter outputformat=json bij een GetFeature request en je krijgt GeoJSON terug. Voorbeeld:
help.paragraph.6.2=<a class="link" target="_blank" href="http://services.geodataoverijssel.nl/geoserver/B51_recreatie/wfs?service=WFS&version=2.0.0&request=GetFeature&typename=B51_recreatie:B5_Fietsroutes_in_Overijssel&count=100&startindex=1&outputformat=json">Fietsroutes in GeoJSON</a>
help.paragraph.6.3=Een GeoPublisher WFS steunt nog meer formaten, zoals gmp, shp, dxf, kml en csv. Zie voor een volledige opsomming het element 'ows:AllowedValues' onder 'ows:Parameter name="outputFormat"' in de <a class="link" target="_blank" href="http://services.geodataoverijssel.nl/geoserver/B51_recreatie/wfs?request=GetCapabilities">Capabilities van de WFS voor bijv. Recreatie</a>
