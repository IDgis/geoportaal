...
about.paragraph.8=WFS JSON als output format:
about.paragraph.9=GML is voor veel webontwikkelaars niet de eerste keus. JSON en GeoJSON zijn laagdrempeliger waardoor veel webontwikkelaars daar de voorkeur aan geven. Gelukkig is het GeoJSON formaat ook beschikbaar bij de WFSen die GeoPublisher aanbiedt. Gebruik daarvoor de parameter outputformat=json bij een GetFeature request en je krijgt GeoJSON terug.
about.paragraph.10=Voorbeeld (voor Firefox, Chrome, Safari en Opera, niet geschikt voor IE):
about.paragraph.11=<a class="link" target="_blank" href="http://services.geodataoverijssel.nl/geoserver/B51_recreatie/wfs?service=WFS&version=2.0.0&request=GetFeature&typename=B51_recreatie:B5_Fietsroutes_in_Overijssel&count=100&startindex=1&outputformat=json">Fietsroutes in GeoJSON</a>
about.paragraph.12=Een GeoPublisher WFS steunt nog meer formaten, zoals gmp, shp, dxf, kml en csv. Zie voor een volledige opsomming het element 'ows:AllowedValues' onder 'ows:Parameter name="outputFormat"' in de <a class="link" target="_blank" href="http://services.geodataoverijssel.nl/geoserver/B51_recreatie/wfs?request=GetCapabilities">Capabilities van de WFS voor bijv. Recreatie</a>
about.paragraph.13=Van een aantal datasets zijn wij geen eigenaar. Meestal zijn hierbij dan beperkingen voordat ze gedeeld mogen worden met anderen. Deze beperkingen staan ook in de beschrijving bij de datasets.
...
help.paragraph.header.3=Over metadata:
help.paragraph.3.1=“Metadata” is de term die bij kaarten vaak wordt gebruikt voor de beschrijving van kaarten. Om het delen van gegevens makkelijker te maken, zijn standaarden gemaakt voor de beschrijving van kaarten. In technische termen: ISO19115 en ISO19119. Deze standaarden worden beheerd door een onafhankelijke organisatie (Geonovum: <a class="link" href="http://www.geonovum.nl" target="_blank">http://www.geonovum.nl</a>).
help.paragraph.header.4=Over downloaden:
help.paragraph.4.1=De bestanden kan je in veel gevallen op je eigen pc opslaan. Dat is handig, omdat je dan zelf de data verder kan bewerken, analyseren of weergeven. Precies zoals jij dat wilt, voor je eigen doeleinden.
help.paragraph.4.2=Gebruik hiervoor de knop “download”. Voor gebruik van dit soort gegevens is speciale software nodig. Dat wordt vaak een GIS genoemd (Geografisch Informatie Systeem). Veel gebruikte systemen zijn Arcgis en QGis. Voor meer informatie over dit soort systemen, zie: <a class="link" href="https://nl.wikipedia.org/wiki/Geografisch_informatiesysteem" target="_blank">https://nl.wikipedia.org/wiki/Geografisch_informatiesysteem</a>.
help.paragraph.4.3=Bij de download kan je kiezen uit verschillend formaten:
help.paragraph.4.3.option.1=<b>SHP</b> (shape, veel gebruikt open formaat, ontwikkeld door Esri)
help.paragraph.4.3.option.2=<b>GML</b> (Geography Markup Language, een open standaard voor GIS data)
...
help.paragraph.header.6=WFS JSON als output format:
help.paragraph.6.1=GML is voor veel webontwikkelaars niet de eerste keus. JSON en GeoJSON zijn laagdrempeliger waardoor veel webontwikkelaars daar de voorkeur aan geven. Gelukkig is het GeoJSON formaat ook beschikbaar bij de WFSen die GeoPublisher aanbiedt. Gebruik daarvoor de parameter outputformat=json bij een GetFeature request en je krijgt GeoJSON terug.
help.paragraph.6.2=Voorbeeld (voor Firefox, Chrome, Safari en Opera, niet geschikt voor IE):
help.paragraph.6.3=<a class="link" target="_blank" href="http://services.geodataoverijssel.nl/geoserver/B51_recreatie/wfs?service=WFS&version=2.0.0&request=GetFeature&typename=B51_recreatie:B5_Fietsroutes_in_Overijssel&count=100&startindex=1&outputformat=json">Fietsroutes in GeoJSON</a>
help.paragraph.6.4=Een GeoPublisher WFS steunt nog meer formaten, zoals gmp, shp, dxf, kml en csv. Zie voor een volledige opsomming het element 'ows:AllowedValues' onder 'ows:Parameter name="outputFormat"' in de <a class="link" target="_blank" href="http://services.geodataoverijssel.nl/geoserver/B51_recreatie/wfs?request=GetCapabilities">Capabilities van de WFS voor bijv. Recreatie</a>
help.paragraph.header.7=Over statische kaarten:
help.paragraph.7.1=Naast bestanden en services kan je ook “statische kaarten” vinden in het Geoportaal. Dat zijn kaarten (meestal pdf’s) die gemaakt zijn op basis van de bestanden en services. Deze kaarten worden speciaal gemaakt voor diverse communicatie-doeleinden.
help.paragraph.7.2=Je kan dit soort kaarten eenvoudig bekijken. Je hebt daarvoor geen geavanceerd GIS systeem voor nodig. Een pdf kan je openen met een PDF reader. Deze readers worden gratis beschikbaar gesteld, bijvoorbeeld door het bedrijf Adobe (<a class="link" href="http://www.adobe.nl" target="_blank">http://www.adobe.nl</a>).  De metadata van deze statische kaarten wordt ontsloten via de Dublin-core standaard.
help.paragraph.header.8=Tips bij het zoeken:
help.paragraph.8.1=Kan je niet snel vinden wat je zoekt, probeer dan eerst eens een term die lijkt op de termen die je al gebruikt. Krijg je teveel zoekresultaten, probeer dan meerdere woorden te zoeken. Het zoekcriterium is “AND”. Dat wil zeggen dat je bij ieder extra woord je zoekresultaten zult beperken.
help.paragraph.8.2=Zoek je bijvoorbeeld “natuur” dan vind je honderden resultaten. Zoek je “natuur bos” dan vind je er al veel minder. Zoeken met wildcards (* of ?) is niet mogelijk. Zoeken naar een deel van een woord echter wel. Zoek je “natuur” dan krijg je ook resultaten waarin het woord “natuurgebied” in voorkomt.
help.paragraph.header.9=Over “Uitgebreid zoeken”:
help.paragraph.9.1=Wil je op een andere manier zoeken dan is dat ook mogelijk. Bij het onderdeel “<b>Uitgebreid zoeken</b>” kan je selecteren of je door alle informatie heen wilt zoeken, of dat je je wilt beperken tot bestanden (geodata), services of statische kaarten. Ook kan je besluiten bij dat onderdeel om de zoekresultaten “<b>uit te klappen</b>”, wat soms ook kan helpen bij het vinden wat je zoekt.
help.paragraph.header.10=Over “Bladeren”:
help.paragraph.10.1=Bij het onderdeel “<b>Bladeren</b>” is de mogelijkheid om te zoeken op trefwoorden. Wil je alles vinden over “economie”, zet dan alleen een vinkje voor het trefwoord “economie”. Wil je alles vinden over “economie” en ook over “flora en fauna”, dan zet je 2 vinkjes bij de betreffende trefwoorden.
help.paragraph.10.2=Zowel bij “Uitgebreid zoeken” als bij “Bladeren” kan je ook nog “gewoon” zoeken op woorden. Dat zorgt ervoor dat jij precies zo kan zoeken als je zelf het makkelijkst vind.
help.paragraph.header.11=Meer hulp nodig?
help.paragraph.11.1=Wij streven ernaar om de informatie zo goed mogelijk beschikbaar te stellen. We streven naar actualiteit en juistheid bij al onze beschikbare bestanden. En we horen ook graag hoe het nog beter zou kunnen.
help.paragraph.11.2=Heb je vragen over het Geoportaal? Of heb je tips of suggesties? Of wil je op de hoogte blijven van de laatste ontwikkelingen?