...
search.intro=Zoek naar kaarten. Maak eventueel eerst een selectie: GIS bestanden, services of overige datasets.
...
about.paragraph.3.3.option.5=<b>Geopackage</b> (bestand met data en ook gegevens over opmaak van de kaart)
