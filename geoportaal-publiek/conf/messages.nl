...
about.paragraph.5.3.option.2=<b>GML</b> (Geography Markup Language, een open standaard voor GIS data)
about.paragraph.5.3.option.3=<b>KML</b> (Keyhole Markup Language, te gebruiken in Google Earth)
about.paragraph.5.3.option.4=<b>DXF</b> (Drawing exchange format, veel gebruikt formaat voor AutoCad)
